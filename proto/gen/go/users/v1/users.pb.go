...
type User struct {
	...
	Country   Country `protobuf:"varint,7,opt,name=country,proto3,enum=users.v1.Country" json:"country,omitempty"`
...
type CreateUserRequest struct {
	...
	Country   Country `protobuf:"varint,6,opt,name=country,proto3,enum=users.v1.Country" json:"country,omitempty"`
}
...
var file_users_v1_users_proto_rawDesc = []byte{
	...
	0x64, 0x12, 0x2b, 0x0a, 0x07, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79, 0x18, 0x07, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x11, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x6f,
	...
	0x52, 0x08, 0x70, 0x61, 0x73, 0x73, 0x77, 0x6f, 0x72, 0x64, 0x12, 0x2b, 0x0a, 0x07, 0x63, 0x6f,
	0x75, 0x6e, 0x74, 0x72, 0x79, 0x18, 0x06, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x11, 0x2e, 0x75, 0x73,
	0x65, 0x72, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79, 0x52, 0x07,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79, 0x22, 0x38, 0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74,
	...
	0x31, 0x2e, 0x55, 0x73, 0x65, 0x72, 0x52, 0x05, 0x75, 0x73, 0x65, 0x72, 0x73, 0x2a, 0x72, 0x0a,
	...
	0x73, 0x2e, 0x76, 0x31, 0x2e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x55, 0x73, 0x65, 0x72, 0x73,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x92, 0x01, 0x0a, 0x0c, 0x63, 0x6f, 0x6d, 0x2e, 0x75,
	0x73, 0x65, 0x72, 0x73, 0x2e, 0x76, 0x31, 0x42, 0x0a, 0x55, 0x73, 0x65, 0x72, 0x73, 0x50, 0x72,
	...
	0x78, 0x61, 0x6d, 0x70, 0x6c, 0x65, 0x73, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x75, 0x73, 0x65, 0x72,
...
var file_users_v1_users_proto_goTypes = []interface{}{
	...
	(*SearchUsersRequest)(nil),  // 12: users.v1.SearchUsersRequest
	(*SearchUsersResponse)(nil), // 13: users.v1.SearchUsersResponse
}
var file_users_v1_users_proto_depIdxs = []int32{
	0,  // 0: users.v1.User.country:type_name -> users.v1.Country
	0,  // 1: users.v1.CreateUserRequest.country:type_name -> users.v1.Country
	1,  // 2: users.v1.CreateUserResponse.user:type_name -> users.v1.User
	1,  // 3: users.v1.GetUserResponse.user:type_name -> users.v1.User
	0,  // 4: users.v1.UpdateUserRequest.country:type_name -> users.v1.Country
	1,  // 5: users.v1.UpdateUserResponse.user:type_name -> users.v1.User
	1,  // 6: users.v1.GetUsersResponse.users:type_name -> users.v1.User
	1,  // 7: users.v1.SearchUsersResponse.users:type_name -> users.v1.User
	2,  // 8: users.v1.UserService.CreateUser:input_type -> users.v1.CreateUserRequest
	4,  // 9: users.v1.UserService.GetUser:input_type -> users.v1.GetUserRequest
	6,  // 10: users.v1.UserService.UpdateUser:input_type -> users.v1.UpdateUserRequest
	8,  // 11: users.v1.UserService.DeleteUser:input_type -> users.v1.DeleteUserRequest
	10, // 12: users.v1.UserService.GetUsers:input_type -> users.v1.GetUsersRequest
	12, // 13: users.v1.UserService.Search:input_type -> users.v1.SearchUsersRequest
	...
	11, // 18: users.v1.UserService.GetUsers:output_type -> users.v1.GetUsersResponse
	13, // 19: users.v1.UserService.Search:output_type -> users.v1.SearchUsersResponse
...
func file_users_v1_users_proto_init() {
	...
	file_users_v1_users_proto_msgTypes[11].OneofWrappers = []interface{}{}
	type x struct{}
