...
import (
	...
	context "context"
	errors "errors"
	users "github.com/bufbuild/buf-examples/gen/users"
	http "net/http"
	strings "strings"
)
...
type UserServiceClient interface {
	...
	Search(context.Context, *connect.Request[users.SearchUsersRequest]) (*connect.Response[users.SearchUsersResponse], error)
}
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	userServiceMethods := users.File_users_users_proto.Services().ByName("UserService").Methods()
	return &userServiceClient{
		...
		search: connect.NewClient[users.SearchUsersRequest, users.SearchUsersResponse](
			httpClient,
...
type userServiceClient struct {
	...
	search     *connect.Client[users.SearchUsersRequest, users.SearchUsersResponse]
}
...
func (c *userServiceClient) DeleteUser(ctx context.Context, req *connect.Request[users.DeleteUserRequest]) (*connect.Response[users.DeleteUserResponse], error) {
	return c.deleteUser.CallUnary(ctx, req)
}

// GetUsers calls users.UserService.GetUsers.
func (c *userServiceClient) GetUsers(ctx context.Context, req *connect.Request[users.GetUsersRequest]) (*connect.Response[users.GetUsersResponse], error) {
	return c.getUsers.CallUnary(ctx, req)
}

// Search calls users.UserService.Search.
func (c *userServiceClient) Search(ctx context.Context, req *connect.Request[users.SearchUsersRequest]) (*connect.Response[users.SearchUsersResponse], error) {
...
func (UnimplementedUserServiceHandler) DeleteUser(context.Context, *connect.Request[users.DeleteUserRequest]) (*connect.Response[users.DeleteUserResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("users.UserService.DeleteUser is not implemented"))
}

func (UnimplementedUserServiceHandler) GetUsers(context.Context, *connect.Request[users.GetUsersRequest]) (*connect.Response[users.GetUsersResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("users.UserService.GetUsers is not implemented"))
}

func (UnimplementedUserServiceHandler) Search(context.Context, *connect.Request[users.SearchUsersRequest]) (*connect.Response[users.SearchUsersResponse], error) {
