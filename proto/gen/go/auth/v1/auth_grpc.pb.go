...
type AuthServiceClient interface {
	...
	RefreshToken(ctx context.Context, in *AuthRefreshRequest, opts ...grpc.CallOption) (*AuthRefreshResponse, error)
...
func (c *authServiceClient) RefreshToken(ctx context.Context, in *AuthRefreshRequest, opts ...grpc.CallOption) (*AuthRefreshResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type AuthServiceServer interface {
	...
	RefreshToken(context.Context, *AuthRefreshRequest) (*AuthRefreshResponse, error)
...
func (UnimplementedAuthServiceServer) RefreshToken(context.Context, *AuthRefreshRequest) (*AuthRefreshResponse, error) {
...
func _AuthService_RefreshToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).RefreshToken(ctx, req.(*AuthRefreshRequest))
	}
	return interceptor(ctx, in, info, handler)
}
